...
var AppleMenu = function (_Component) {
    ...
    _createClass(AppleMenu, [{
        ...
        value: function componentWillUpdate(x, y, z) {
            console.log(111, x, y, z);
        }
    }, {
        key: 'mouseEnter',
        ...
        value: function updateExtandImg() {
            ...
            this.setState({ extendImg: this.state.extend.map(function (value) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { ref: 'target', onClick: this.props.dock && this.extendImg, onMouseEnter: this.mouseEnter, onMouseMove: this.mouseMove, onMouseLeave: this.mouseOut,
                    style: body },
                ...
                _react2.default.createElement(
                    'div',
                    { style: { alignSelf: order, height: this.size, width: "10px", background: "red" } },
